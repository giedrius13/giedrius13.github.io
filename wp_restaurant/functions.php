...
// Pridedame paveiksliuko dydi
add_image_size('logo', 158, 93);
...
function theme_scripts(){
  ...
  //       wp_deregister_script('jquery');
		// wp_register_script('jquery', ASSETS_URL . 'http://code.jquery.com/jquery-1.11.3.min.js', false, '1.11.3', true);

		// assets/js/menu.js


        wp_register_script('menu', ASSETS_URL . '/assets/js/menu.js', array('jquery'), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('custom', ASSETS_URL . '/assets/css/style.css', array(), '1', 'all');

		wp_register_style('font-awesome', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), false, 'all');
